<template>
    <div class="flex flex-1 justify-end items-center text-right px-4">
        ...
        >
            <label for="search" class="hidden">جستجو</label>
            ...
            <transition name="fade">
                <div v-if="query" class="absolute left-0 right-0 md:inset-auto w-full lg:w-3/4 text-left mb-4 md:mt-10">
                    <div class="flex flex-col bg-white border border-b-0 border-t-0 border-blue-400 rounded-b-lg shadow-lg mx-4 md:mx-0">
                        ...
                        >
                            <p class="my-0">نتیجه‌ای برای <strong>{{ query }}</strong> پیدا نشد</p>
                        </div>
                    </div>
                </div>
            </transition>
        ...
        <button
            ...
            type="button"
            class="flex md:hidden bg-gray-100 hover:bg-blue-100 justify-center items-center border border-gray-500 outline-non focus:outline-none h-10 px-3"
